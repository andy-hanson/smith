require('just-the-job') ->
	...
	@task 'compile',
		...
		['compile-compiler'],
		'bin/smith'  #--quiet --print-module-defines # --just Main.smith --no-checks --no-meta
	...
	@task 'all',
		'Generate (but do not install) Sublime Text files, lint, compile and run',
		[ 'generate-sublime-files', 'lint', 'run' ]
