require('just-the-job') ->
	...
	@task 'clean',
		...
		'rm -rf editor/Smith.tmTheme editor/Smith.tmLanguage node_modules compiler-js js docs'
	@task 'lint',
	...
	@task 'compile-compiler',
		...
		'node_modules/coffee-script/bin/coffee --compile --bare --map --output compiler-js compiler-source'
	@task 'compile',
		'Compile all code in source',
		['compile-compiler'],
		'bin/smith' #'bin/smith --no-nazi'  #--verbose --print-module-defines # --just Main.smith --no-checks --no-meta
	...
	@task 'doc',
		'Document',
		'node_modules/coffeedoc/bin/coffeedoc compiler-source'
