...
Function.prototype.toType = function() {
	if (this.__type == null)
		this.__type = new constructType(this.name, null, this.prototype);
	return this.__type;
}

var next_type_id = 0;

var constructType = function(name, superType, proto) {
...
Type = new constructType('Type', null, constructType.prototype);
